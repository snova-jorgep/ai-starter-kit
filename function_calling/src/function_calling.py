...
Your answer always must be in the same language as the initial query.
...
class ConversationalResponse(BaseModel):
    (
        ...
        'or if you have a final answer. response always must be in the same language as the user query'
    )

    response: str = Field(
        ...,
        description='Conversational response to the user. response always must be in the same language as the initial user query, tipically hungarian',
    )
